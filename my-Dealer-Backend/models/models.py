...
class Farmer(db.Model):
    ...
    def __repr__(self):
        return f"<Farmer id={self.id}, user_id={self.user_id}, farm_name={self.farm_name}>"
...
class Supplier(db.Model):
    ...
    user = db.relationship("User", back_populates="supplier")
    ...
    def __repr__(self):
        return f"<Supplier id={self.id}, user_id={self.user_id}, company_name={self.company_name}>"
...
class Product(db.Model):
    ...
    def __repr__(self):
        return f"<Product id={self.id}, name={self.product_name}, farmer_id={self.farmer_id}>"